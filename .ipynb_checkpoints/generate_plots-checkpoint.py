...
if __name__ == '__main__':
    ...
    time_plot(confirmed, ['Italy', 'Spain', 'France', 'Germany', 'US', 'Canada']).figure.savefig('plots/confirmed_delay.png', bbox_inches='tight')
    time_plot(confirmed, ['China', 'Italy']).figure.savefig('plots/confirmed_china-vs-italy.png', bbox_inches='tight')
    ...
    regioni.plot('totale_casi', five_most_cases, title='Total cases').figure.savefig('plots/cases.png', bbox_inches='tight')
    regioni.plot('deceduti', five_most_cases, title = 'Total deaths', ylabel='Deaths').figure.savefig('plots/deaths.png', bbox_inches='tight')
    regioni.plot('deceduti', five_most_cases, norm='totale_casi', title = 'Mortality rate (deaths/tot cases)', ylabel = 'Rate').figure.savefig('plots/mortality.png', bbox_inches='tight')
    regioni.plot('terapia_intensiva', five_most_cases, norm='totale_ospedalizzati', title = 'ICU rate among hospitalized', ylabel = 'Rate').figure.savefig('plots/ICU_rate.png', bbox_inches='tight')
